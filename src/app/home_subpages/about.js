...
export default function About() {
  ...
  function Track({ title, desc, children }) {
    return (
      <div
        className="p-4 flex flex-col items-center w-64 rounded-lg border-transparent
    ...
    <div className="about-page">
      <div className="about-content">
        ...
        <div className="about-text" data-aos="fade-up">
          <p>
            Join hackUMBC for our 24-hour hackathon event where we challenge our
            ideas to come to life! Collaborate with other students and pick up
            some new skills in our workshop sessions!
          </p>

          <p>
            With lots of fun activities, over $5,000 in prizes, and swag for all
            participants, you'll be in for an exciting weekend!
          </p>
        </div>
        <div className="tracks flex" data-aos="fade-up">
          {" "}
          {/* adjusted the className styling for centering on mobile for tracks */}
          <Track
            title="General"
