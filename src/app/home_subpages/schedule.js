...
export default function Schedule() {
    ...
    const day1Schedule = [
        ...
        { time: '1:00 PM', endTime: '2:00 PM', event: 'MLH Workshop: Intro to Google AI Studio & Hacking with GitHub Copilot', location: 'RAC 106', type: 'event' },
        { time: '2:00 PM', endTime: '2:45 PM', event: 'Nightwing Workshop: How to Land a Job in Cybersecurity', location: 'RAC 144', type: 'event' },
        { time: '2:00 PM', endTime: '3:00 PM', event: 'DoIT Workshop: Using AI to Build Faster', location: 'RAC 106', type: 'event' },
        { time: '2:50 PM', endTime: '3:35 PM', event: 'SWE Workshop: Fighting Gender and Minority Bias in AI', location: 'RAC 144', type: 'event' },
        { time: '3:00 PM', endTime: '3:40 PM', event: 'CyberDawgs Workshop: Cybersecurity Software Workshop', location: 'RAC 106', type: 'event' },
        { time: '3:40 PM', endTime: '4:25 PM', event: 'ETF Workshop: Investigating Your Physical and Digital Footprint', location: 'RAC 144', type: 'event' },
        { time: '3:40 PM', endTime: '4:25 PM', event: 'GDG Workshop: Workshop on Autonomous Multi-Agent Development', location: 'RAC 106', type: 'event' },
        { time: '4:30 PM', endTime: '5:15 PM', event: 'GESCoM Workshop: What Am I Looking At? How to Identify Plants and Animals with GESCoM', location: 'RAC 144', type: 'event' },
        { time: '4:30 PM', endTime: '5:15 PM', event: 'SAD Workshop: Intro to Virtual Machines (VMs)', location: 'RAC 106', type: 'event' },
        { time: '5:20 PM', endTime: '6:05 PM', event: 'STARS Workshop: Intro to Web Scraping', location: 'RAC 144', type: 'event' },
        { time: '5:20 PM', endTime: '6:05 PM', event: 'NSBE Workshop: AI Text Embedding', location: 'RAC 106', type: 'event' },
    ...
    const day2Schedule = [
        { time: '9:00 AM', endTime: '10:00 AM', event: 'Breakfast', location: 'RAC Arena', type: 'event' },
        { time: '11:00 AM', endTime: '12:00 PM', event: 'Begin Hack Submission', location: 'RAC Arena', type: 'event' },
