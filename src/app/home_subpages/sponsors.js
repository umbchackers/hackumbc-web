...
export default function Sponsors() {
    ...
    return (
        <div
            className="sponsors-page relative"
            style={{
            ...
            <div className="sponsors-content relative z-10" data-aos="fade-up">
                <div className="sponsors-unified-container" data-aos="fade-up">
                    ...
                    <div className="sponsors-all-logos">
                        ...
                        {/* Diamond */}
                        <div className="sponsor-link diamond">
                            <a
                        ...
                        {/* Platinum */}
                        <div className="sponsor-link platinum">
                            <a
                        ...
                        {/* Gold */}
                        <div className="sponsor-link gold">
                            <a
                        ...
                        {/* Silver */}
                        <div className="sponsor-link silver">
                            <a
                        ...
                        {/* Bronze */}
                        <div className="sponsor-link bronze">
                            <a
                        ...
                        {/* Partners */}
                        <div className="sponsor-link partner">
                            <a
