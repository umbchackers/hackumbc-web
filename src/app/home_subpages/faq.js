...
export default function FAQ() {
  ...
  return (
    ...
    >
      <div
        className="faq-section-title relative z-10 text-black"
        data-aos="fade-up"
      >
        <SectionTitle title="FAQ" />
      </div>
      <div
        className="faq-title-subheading relative z-10 text-black"
        data-aos="fade-up"
      >
        Frequently Asked Questions
      </div>
      <div className="faq-content relative z-10" data-aos="fade-up">
        <FAQItem
